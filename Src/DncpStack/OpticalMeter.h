...
void OpticalMeter_SetMeterLEDLevel(DscpDevice* dscp, Byte* data, Uint16 len);
void OpticalMeter_GetMeterLEDLevel(DscpDevice* dscp, Byte* data, Uint16 len);
...
#define CMD_TABLE_OPTICAL_METER \
    ...
    DSCP_CMD_ENTRY(DSCP_CMD_OMI_SET_METER_LED_LEVEL, OpticalMeter_SetMeterLEDLevel), \
    DSCP_CMD_ENTRY(DSCP_CMD_OMI_GET_METER_LED_LEVEL, OpticalMeter_GetMeterLEDLevel), \
