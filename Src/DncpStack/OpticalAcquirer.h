...
#define CMD_TABLE_OPTICALACQUIRE \
        ...
        DSCP_CMD_ENTRY(DSCP_CMD_OAI_GET_ADC_WORK_MODE, OpticalAcquirer_GetADCWorkMode), \
        DSCP_CMD_ENTRY(DSCP_CMD_OAI_SET_ADC_WORK_MODE, OpticalAcquirer_SetADCWorkMode)
