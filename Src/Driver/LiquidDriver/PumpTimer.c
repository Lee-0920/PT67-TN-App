...
#define PUMP_TIMERB_RCC                RCC_APB1Periph_TIM12
#define PUMP_TIMERB_RCC_CONFIG         RCC_APB1PeriphClockCmd(PUMP_TIMERB_RCC,ENABLE)
#define PUMP_TIMERB_IRQn               TIM8_BRK_TIM12_IRQn
#define PUMP_TIMERB_IRQHANDLER         TIM8_BRK_TIM12_IRQHandler
#define PUMP_TIMERB                    TIM12
