...
// **************** 引脚定义 ****************
// 氙灯触发控制管脚
#define OPT_XONEN_TRIGGER_PIN                   GPIO_Pin_7
#define OPT_XONEN_TRIGGER_PORT                  GPIOA
#define OPT_XONEN_TRIGGER_RCC                   RCC_AHB1Periph_GPIOA
...
// 氙灯积分清零信号
#define OPT_XONEN_INTEGRAL_CLEAR_PIN            GPIO_Pin_12
#define OPT_XONEN_INTEGRAL_CLEAR_PORT           GPIOE
#define OPT_XONEN_INTEGRAL_CLEAR_RCC            RCC_AHB1Periph_GPIOE
...
// 氙灯积分信号
#define OPT_XONEN_INTEGRAL_PIN                  GPIO_Pin_13
#define OPT_XONEN_INTEGRAL_PORT                 GPIOE
#define OPT_XONEN_INTEGRAL_RCC                  RCC_AHB1Periph_GPIOE
