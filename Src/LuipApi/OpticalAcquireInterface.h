 ...
 * @param index Uint8, ADC索引  AD7791-0(TP) ADS1146-1(TN)
 ...
 * @param index Uint8，目标LED索引号[tpref=0,tpmea=1,meter1=2,meter2=3,tn220=4,tn275=5]。
 * @param targetAD Uint32，目标AD。
 * @return 状态回应，Uint16，支持的状态有：
 *  - @ref DSCP_OK  操作成功；
 *  - @ref DSCP_ERROR 操作失败；
 ...
 * @param ads7791_reference Uint32，参考端AD。
 * @param ads7791_measure Uint32，测量端AD。
 * @param ads1146_reference Uint32，参考端AD。
 * @param ads1146_measure Uint32，测量端AD。
 */
