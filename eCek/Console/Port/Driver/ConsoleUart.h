...
#define USARTx_CLK_CONFIG              RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART3, ENABLE)
#define USARTx_RX_CONFIG               RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB, ENABLE)
#define USARTx_TX_CONFIG               RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB, ENABLE)
#define USARTx                         USART3
#define USARTx_GPIO_AF                 GPIO_AF_USART3
#define USARTx_TX_PIN                  GPIO_Pin_10
#define USARTx_TX_PinSource            GPIO_PinSource10
#define USARTx_TX_GPIO_PORT            GPIOB
#define USARTx_RX_PIN                  GPIO_Pin_11
#define USARTx_RX_PinSource            GPIO_PinSource11
